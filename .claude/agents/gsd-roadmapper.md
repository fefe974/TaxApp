...
Reference full template: `/home/user/TaxApp/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/TaxApp/.claude/get-shit-done/templates/state.md`.
