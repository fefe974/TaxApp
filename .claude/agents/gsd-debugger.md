...
<required_reading>
@/home/user/TaxApp/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/user/TaxApp/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/TaxApp/.claude
                  → checks /home/user/TaxApp/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/TaxApp/.claude/get-shit-done
                  → writes to /home/user/TaxApp/.claude/get-shit-done/hooks/
...
@/home/user/TaxApp/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/user/TaxApp/.claude/get-shit-done/references/common-bug-patterns.md
