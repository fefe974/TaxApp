...
<execution_context>
@/home/user/TaxApp/.claude/get-shit-done/workflows/manager.md
...
Read and execute `/home/user/TaxApp/.claude/get-shit-done/workflows/analyze-dependencies.md` end-to-end.
