...
```markdown
Read /home/user/TaxApp/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/TaxApp/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/TaxApp/.claude/agents/gsd-ui-checker.md for instructions.
