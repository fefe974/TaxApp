...
```
Agent(
  prompt="Read /home/user/TaxApp/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/TaxApp/.claude/get-shit-done/templates/VALIDATION.md`
